...
## Standard Annual Model
- One column per financial year
- Period headers show year-end date (e.g., "Jun 25")
- Days in period = 365 or 366 (leap year)

## Mixed Periodicity (Construction Monthly -> Operations Annual)
...
- Common for Australian listed companies
- Two columns per financial year
